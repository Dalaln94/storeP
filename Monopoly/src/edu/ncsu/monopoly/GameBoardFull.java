...
public class GameBoardFull extends GameBoard {
    public GameBoardFull() {
        ...
        Monopolyinterfacee cc1 = new CardCell(Card.TYPE_CC, "Community Chest 1");
        ...
        Monopolyinterfacee c1 = new CardCell(Card.TYPE_CHANCE, "Chance 1");
        ...
        Monopolyinterfacee cc2 = new CardCell(Card.TYPE_CC, "Community Chest 2");
        ...
        Monopolyinterfacee c2 = new CardCell(Card.TYPE_CHANCE, "Chance 2");
        ...
        Monopolyinterfacee cc3 = new CardCell(Card.TYPE_CC, "Community Chest 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        Monopolyinterfacee c3 = new CardCell(Card.TYPE_CHANCE, "Chance 3");
